...
var he = function(t2) {
  function o2(o3) {
    ...
    if ((r3 = t2.call(this, o3) || this)._getMinZoom = function() {
        ...
        r3.props.googleMapLoader(t3, r3.props.heatmapLibrary).then(function(e3) {
          if (r3.mounted_) {
            ...
            r3.overlay_ = M2, M2.setMap(g2), r3.props.heatmap.positions && r3.heatmap.setMap(g2), r3.props.onTilesLoaded && e3.event.addListener(g2, "tilesloaded", function() {
              ...
              v2.geoService_.getZoom() !== g2.getZoom() && (v2.zoomAnimationInProgress_ || (v2.zoomAnimationInProgress_ = true, v2._onZoomAnimationStart(g2.zoom)), f2 < 32) && ((/* @__PURE__ */ new Date()).getTime() - r3.zoomControlClickTime_ < 300 ? S(function() {
                return S(function() {
      ...
      j().isChrome && (r3.zoomControlClickTime_ = (/* @__PURE__ */ new Date()).getTime());
